...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	motorY.SetPorts(M3_DIR_GPIO_Port, M3_DIR_Pin, M3_EN_GPIO_Port, M3_EN_Pin, M3_END_GPIO_Port, M3_END_Pin);
	motorY.SetPWM(&htim3, TIM_CHANNEL_1);

	motorZ.SetPorts(M2_DIR_GPIO_Port, M2_DIR_Pin, M2_EN_GPIO_Port, M2_EN_Pin, M2_END_GPIO_Port, M2_END_Pin );
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, M2_DIR_Pin|M2_EN_Pin|Orange_Led_Pin|Green_Led_Pin
  ...
  GPIO_InitStruct.Pin = M2_DIR_Pin|M2_EN_Pin|Orange_Led_Pin|Green_Led_Pin
                          |M3_VCC_END_Pin|M1_GND_END_Pin;
  ...
  /*Configure GPIO pins : USART_VSS_Pin M3_VCC_Pin M3_EN_Pin M3_DIR_Pin
                           M1_VCC_END_Pin M2_GND_END_Pin M2_VCC_END_Pin M1_EN_Pin
                           M1_DIR_Pin */
  GPIO_InitStruct.Pin = USART_VSS_Pin|M3_VCC_Pin|M3_EN_Pin|M3_DIR_Pin
                          |M1_VCC_END_Pin|M2_GND_END_Pin|M2_VCC_END_Pin|M1_EN_Pin
                          |M1_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pin : M3_GND_END_Pin */
  GPIO_InitStruct.Pin = M3_GND_END_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(M3_GND_END_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : M3_END_Pin */
  GPIO_InitStruct.Pin = M3_END_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(M3_END_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : M1_END_Pin */
  GPIO_InitStruct.Pin = M1_END_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(M1_END_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : M2_END_Pin */
  GPIO_InitStruct.Pin = M2_END_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(M2_END_GPIO_Port, &GPIO_InitStruct);
